    ...
    function(t) {
        ...
        var r = {
            ...
            extend: function(t) {
                for (var e = arguments.length,
                         i = Array(e > 1 ? e - 1 : 0), r = 1; r < e; r++) i[r - 1] = arguments[r];
        ...
        function(t, e, i) {
            ...
            var n = i(7),
                ...
                a = r(o),
                l = a.
                default.isPhone() ? document.body.clientWidth: 360,
                u = a.
                default.isPhone() ? document.body.clientHeight: 600,
                h = function() {
                    return {
                        width: l,
                        height: u,
                        ...
                        dialogue: [{
                            ...
                            {
                                type: 6,
                                txt: "偶尔邻居家小女孩坐在院子里吃糍粑的时候"
                            },
                            {
                                type: 6,
                                txt: "能看到尾巴上不小心粘着星星的松鼠飞奔过去"
                            }],
                        sunset: 8e3,
                        ...
                        fireWords: "Just|for|QN|新的一年|依然爱你",
            ...
            h.dialogueOpt.interval = a.
            default.transTime(h.dialogueOpt.interval, 120),
                h.dialogueOpt.speed = a.
                default.transTime(h.dialogueOpt.speed, 18),
                h.sunset = a.
                default.transTime(h.sunset, 600),
                h.fireOpt.wordInterval = a.
                default.transTime(h.fireOpt.wordInterval, 180),
                h.fireOpt.denseTime = a.
                default.transTime(h.fireOpt.denseTime, 600),
                h.titleOpt.delay = a.
                default.transTime(h.titleOpt.delay, 240),
                h.titleOpt.e = a.
                default.transTime(h.titleOpt.e, 240),
                (0, s.
                    default)(h.width, h.height, h.canvases),
                e.
                    default = h
        },
        function(t, e, i) {
                        ...
                        return o(t, [{
                                ...
                                value: function() {
                                    ...
                                    this.height = l.
                                        ...
                                        this.width = l.
                                            default.width,
                                        l.
                                        default.canvases.forEach(function(e) {
                                        ...
                                        this.fireworks = [],
                                        this.fireworkTime = 0 | h.
                                        default.random.apply(h.
                                            default, n(l.
                                            default.fireworkInterval)),
                                        this.fireWords = l.
                                        default.fireWords.split("|"),
                                        this.fireOpt = h.
                                        default.extend({
                                                end:
                                                    !1,
                                    ...
                                    switch (t) {
                                        case 1:
                                            this.dialogueOpt = null,
                                                this.dialogue = null,
                                                this.dialogueCtx.clearRect(0, 0, l.
                                                    default.width, l.
                                                    default.height),
                                                ++this.status;
                                            break;
                                        ...
                                        case 3:
                                            this.fireOpt = null,
                                                ...
                                                l.
                                                    default.shape.gap = l.
                                                    default.titleOpt.gap,
                                                l.
                                                    default.word.size = l.
                                                    default.titleOpt.size,
                                                ++this.status;
                                            break;
                                        case 4:
                                            this.titleOpt = null,
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    switch (this.fallCtx.clearRect(0, 0, this.width, this.height), this.fallType) {
                                        case "snow":
                                            this.time % l.
                                                default.snowInterval == 0 && this.fallDots.push(new v.
                                            default(l.
                                                default.snow));
                                            break;
                                        case "heart":
                                            this.time % l.
                                                default.heartInterval == 0 && this.fallDots.push(new w.
                                            default(l.
                                                default.heart));
                                            break;
                                        case "mix":
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    if (t.clearRect(0, 0, l.
                                        default.width, l.
                                        default.height), t.fillStyle = this.dialogueOpt["color" + this.dialogue.type] || this.dialogueOpt.color1, t.font = this.dialogueOpt["font" + this.dialogue.type] || this.dialogueOpt.font1, this.dialogue.current = this.dialogue.current || 0, --this.dialogueOpt.speed <= 0 && (this.dialogueOpt.speed = l.
                                        default.dialogueOpt.speed, ++this.dialogue.current), t.fillText(this.dialogue.txt.slice(0, this.dialogue.current), 20, 50), this.dialogue.current >= this.dialogue.txt.length && --this.dialogueOpt.interval <= 0) {
                                        if (0 == l.
                                            default.dialogue.length) return this.go(1);
                                        this.dialogue = l.
                                        default.dialogue.shift(),
                                            this.dialogueOpt.interval = l.
                                                default.dialogueOpt.interval
                                    }
                                }
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    this.fireworkCtx.fillStyle = "hsla(210, 60%, 5%, " + .01 * (20 - this.sunsetTime / l.
                                        default.sunset * 20) + ")",
                                        this.fireworkCtx.fillRect(0, 0, l.
                                            default.width, l.
                                            default.height)
                                }
                            },
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    if (0 == this.fireWords.length) return this.fireOpt.end = !0,
                                        void(this.fireOpt.time = 180); --this.fireOpt.wordInterval <= 0 && (this.getDotsPostion(this.fireWords.shift(), !0), this.fireOpt.wordInterval = l.
                                        default.fireOpt.wordInterval)
                                }
                            },
                            {
                                key: "createDenseFire",
                                value: function() {
                                    for (var t = this,
                                             e = 0; e < 10; e++) setTimeout(function() {
                                            t.fireworks.push(new b.
                                            default(l.
                                                default.fireworks))
                                        },
                                        100 * e)
                            ...
                            },
                            {
                                key: "renderFireworks",
                                value: function() {
                                    this.fireworkCtx.fillStyle = l.
                                    default.skyColor.replace("{lightness}", 5 + 15 * this.skyColor.lightness).replace("{hue}", this.skyColor.hue),
                                    ...
                                    for (var t = this.fireworks.length - 1; t >= 0; --t) this.skyColor = this.skyColor.lightness >= this.fireworks[t].getSkyColor().lightness ? this.skyColor: this.fireworks[t].getSkyColor(),
                                    !this.fireworks[t].render(this.fireworkCtx) && this.fireworks.splice(t, 1)
                                }
                            },
                            {
                                key: "createFireworks",
                                value: function() {--this.fireworkTime <= 0 && (this.fireworks.push(new b.
                                default(l.
                                    default.fireworks)), this.fireworkTime = 0 | h.
                                default.random.apply(h.
                                    default, n(l.
                                    default.fireworkInterval)))
                                }
                            },
                            {
                                ...
                                value: function() {
                                    if (this.createCanvas(), this.createTitleDots(), this.titleOpt) {
                                        ...
                                        for (var e in this.titleDots) this.titleDots[e].render(t); --this.titleOpt.time <= 0 && (this.titleOpt.start = !1)
                                    }
                                }
                            },
                            {
                                key: "createCanvas",
                                value: function() {
                                    if (!this.titleOpt.start) {++this.titleOpt.current;
                                        var t = document.createElement("canvas");
                                        t.setAttribute("class", "title"),
                                            t.id = this.titleOpt.current,
                                            t.setAttribute("width", l.
                                                default.width),
                                ...
                                value: function() {
                                    ...
                                    if (!this.titleOpt.start) {
                                        ...
                                        this.titleDots = [],
                                            ...
                                            this.titleOpt.time = l.
                                                default.titleOpt.e + l.
                                                default.titleOpt.delay,
                                            l.
                                                default.word.y += l.
                                                default.titleOpt.distance;
                                        this.getDotsPostion(this.titleWords.shift()).forEach(function(e) {
                                            var i = {
                                                ...
                                                default.random(0, l.
                                                    default.width),
                                                yStart: h.
                                                default.random( - 100, 0),
                                                size: l.
                                                    default.titleOpt.pSize,
                                                e: l.
                                                    default.titleOpt.e
                                            };
                                            t.titleDots.push(new _.
                                            default(i))
                                        }),
                                            this.fallType = "mix"
                                    }
                            ...
                            },
                            {
                                ...
                                value: function(t, e) {
                                    ...
                                    return r.forEach(function(t, r) {
                                        var h = void 0;
                                        h = s % 2 == 0 ? l.
                                            default.width / 2 + (r - s / 2) * o + .5 * o: l.
                                            default.width / 2 + (r - Math.floor(s / 2)) * o,
                                            i.shapeMaker.write({
                                                txt: t,
                                                x: h,
                                                y: a,
                                        ...
                                        var f = i.shapeMaker.getDots(l.
                                            default.shape);
                                        u.push.apply(u, n(f));
                                        var c = {};
                                        e && i.fireworks.push(new b.
                                        default({
                                            wait:
                                                30,
                                            radius: 2,
                ...
                v = function() {
                    function t() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                            ...
                            P = e.prtOption,
                            S = void 0 === P ? {}: P;
                        if (s(this, t), this.x = i || h.
                        default.random(l.
                            default.width / 8, 7 * l.
                            default.width / 8), this.y = o, this.xEnd = a || this.x, this.yEnd = u || h.
                        default.random(l.
                            default.height / 8, 3 * l.
                            default.height / 8), this.size = c, this.opacity = b, this.velocity = -Math.abs(w), this.wait = k || h.
                        default.random(30, 60), this.radius = h.
                        default.random.apply(h.
                            default, n(v)), this.GRAVITY = y, this.hue = 360 * Math.random() | 0, this.color = _ || "hsla(" + this.hue + ",80%,60%,1)", this.status = 1, z) {
                            this.type = "words";
                            var T = {
                                xStart: this.xEnd,
                                yStart: this.yEnd
                    ...
                    return o(t, [{
                        key: "createParticles",
                        value: function() {
                            for (var t = 0; t < this.count; ++t) this.particles.push(new c.
                            default({
                                x:
                                this.xEnd,
                                y: this.yEnd,
                        ...
                        },
                        {
                            ...
                            value: function() {
                                for (var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                         e = t.mini, i = void 0 === e ? 1 : e, r = t.gap, n = void 0 === r ? 5 : r, s = this.y - this.size / 2, o = this.canvas.width, a = this.size, l = this.ctx.getImageData(0, s, o, a).data, u = [], h = 0, f = s, c = 0, d = 0, p = l.length; d <= p; d += 4 * n) l[d + 3] > 0 && ++c % i == 0 && u.push({
                                    x: h,
                                    y: f
                                }),
